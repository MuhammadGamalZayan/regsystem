                                          ...
                                          <div class="col-10">
                                            <div class="card" style="border-radius: 15px;background: transparent;box-shadow: none;">
                                              <div class="card-body p-5">
                                                <!-- <h4 class="text-uppercase text-center" style="margin-bottom: 22px;">Search By Barcode</h4> -->
                                                <div class="form-outline mb-2" style="border-radius: 15px;">
                                                    <!-- <label class="form-label" for="name">Name</label> -->
                                                  <input type="text" id="name" name="name" class="form-control form-control-lg" placeholder="Search By Barcode"/>
                                                </div> 
                                              </div>
                                            </div>
                                          </div>
